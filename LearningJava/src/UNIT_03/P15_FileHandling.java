...
class ABCDEF {
	...
	void takeInputFromAFileNotFromConsole() throws IOException {
		...
		String path = "C:\\Users\\DELL\\git\\Learningjava\\LearningJava\\LearningJava\\src\\UNIT_03\\Input.txt";
	...
	void saveOutputIntoAFile() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\DELL\\git\\Learningjava\\LearningJava\\LearningJava\\src\\UNIT_03\\output.txt");
		} catch (IOException e) {
	...
	void saveLogOfProgram() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\DELL\\git\\Learningjava\\LearningJava\\LearningJava\\src\\UNIT_03\\log.txt",true);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
